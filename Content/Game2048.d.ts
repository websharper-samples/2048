...
declare module Game2048 {
    module Client {
        ...
        interface HtmlActuator {
            Actuate(grid: any, state: any): void;
            ClearMessage(): void;
        }
        interface StoredGame {
            Values: __ABBREV.__WebSharper.OptionProxy<any>;
            Score: number;
            BestScore: number;
        }
        var gridValues : {
        ...
        var moveGrid : {
            (scoreRef: __ABBREV.__LocalStorage.IValue<number>, merge: __ABBREV.__WebSharper.F2<number, number, __ABBREV.__WebSharper.OptionProxy<any>>, grid: any, dir: __ABBREV.__InputManager.Direction): __ABBREV.__WebSharper.OptionProxy<any>;
        };
        var Main : {
            (): void;
        };
    ...
    module LocalStorage {
        interface IValue<_T1> {
            get_Value(): _T1;
            set_Value(x0: _T1): void;
        }
        interface Ref<_T1> {
            get_Value(): _T1;
            set_Value(value: _T1): void;
        }
        interface IStorageItem<_T1> {
            Save(): void;
            Delete(): void;
        }
        interface JSONStorageItem<_T1> {
            get_Value(): _T1;
            set_Value(v: _T1): void;
            Save(): void;
            Delete(): void;
            getValue(): _T1;
        }
        var incr : {
            (i: __ABBREV.__LocalStorage.IValue<number>): void;
        };
        var decr : {
            (i: __ABBREV.__LocalStorage.IValue<number>): void;
        };
        var localStorage : {
            (): __ABBREV.__JavaScript.Storage;
        };
    }
    module InputManager {
        interface Direction {
        ...
        interface InputManager {
            bindButtonPress(e: __ABBREV.__Control.FSharpEvent<void>, jq: __ABBREV.__JQuery.JQuery): void;
            get_Move(): any;
            get_Restart(): any;
            get_KeepPlaying(): any;
        }
    ...
    module Variants {
        interface OriginalRules {
            Merge(v1: number, v2: number): __ABBREV.__WebSharper.OptionProxy<any>;
            Goal(grid: any): boolean;
            NewTileValue(): number;
            Next(grid: any): void;
            Start(): any;
            get_Name(): string;
            get_Title(): string;
            get_Hint(): string;
            get_GoalValue(): number;
        }
        interface FibonacciRules {
            Merge(v1: number, v2: number): __ABBREV.__WebSharper.OptionProxy<any>;
            NewTileValue(): number;
            get_Name(): string;
            get_Title(): string;
    ...
    module Model {
        ...
        interface Tile {
            Current: any;
            Previous: __ABBREV.__WebSharper.OptionProxy<any>;
            MergedFrom: any[];
        }
        var newTile : {
            (pos_0: number, pos_1: number, value: number): any;
        };
        var moveTile : {
            (newPos_0: number, newPos_1: number, tile: any): any;
        };
        var mergeTiles : {
            (newPos_0: number, newPos_1: number, newValue: number, tile1: any, tile2: any): any;
        };
        var addRandomTile : {
            (grid: any, value: number): void;
        };
        var gridContains : {
            (grid: any, value: number): boolean;
        };
        var doMerge : {
            (scoreRef: __ABBREV.__LocalStorage.IValue<number>, merge: __ABBREV.__WebSharper.F2<number, number, __ABBREV.__WebSharper.OptionProxy<any>>, getnextPos: {
                (): any;
            }, row: any[]): any[];
        };
        var moveAvailable : {
            <_M1>(merge: __ABBREV.__WebSharper.F2<number, number, __ABBREV.__WebSharper.OptionProxy<_M1>>, grid: any): boolean;
        };
    }
    module Array {
        var pad : {
            <_M1>(length: number, array: _M1[]): __ABBREV.__WebSharper.OptionProxy<_M1>[];
        };
    }
    module Array2D {
        var exists : {
        ...
        var toSeq : {
            <_M1>(array: any): __ABBREV.__WebSharper.seq<_M1>;
        };
    }
}
declare module IntelliFactory {
...
declare module __ABBREV {
    ...
    export import __WebSharper = IntelliFactory.WebSharper;
    export import __LocalStorage = Game2048.LocalStorage;
    export import __InputManager = Game2048.InputManager;
    export import __JavaScript = IntelliFactory.WebSharper.JavaScript;
    export import __Control = IntelliFactory.WebSharper.Control;
    export import __JQuery = IntelliFactory.WebSharper.JQuery;
    export import __Model = Game2048.Model;
}
