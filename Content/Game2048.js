 ...
 Runtime.Define(Global,{
  Game2048:{
   ...
   Client:{
     ...
     Actuate:function(grid,state)
     {
      ...
      return window.requestAnimationFrame(function()
      {
       ...
       applyClasses=function(el)
       {
        ...
        {
         var value,objectArg,arg00;
         value=Strings.concat(" ",classes);
         objectArg=el["HtmlProvider@33"];
         arg00=el.get_Body();
         return objectArg.SetAttribute(arg00,"class",value);
        };
       };
       addTile=function(moveTo)
       {
        return function(addClass)
        {
         ...
         {
          var inner,classes,a,wrapper,pos;
          inner=Default.Div(List.ofArray([Default.Attr().Class("tile-inner"),Default.Text(Global.String(tile.Value))]));
          a=List.ofArray(["tile","tile-"+Global.String(tile.Value),positionClass(tile.Pos)]);
          classes=ResizeArrayProxy.New11(List.append(a,addClass));
       ...
       if(diff>0)
        {
         _this.scoreContainer.append(Default.Div(List.ofArray([Default.Attr().Class("score-addition"),Default.Text("+"+Global.String(diff))])).Dom);
        }
    ...
    {
     var _selectGameType_163_1,idx,v,_rules_168_1,_gridContainer_170_1,i,_storedGame_179_1,_score_181_1,_bestScore_182_1,_grid_183_1,_keepPlaying_194_1,_isGameTerminated_195_1,_actuator_197_1,_inputManager_199_1,_actuate_208_1,continueGame,_setRules_223_1,_objectArg_254,_arg00_267_1,_arg00_270_2;
     ...
     for(i=1;i<=4;i++){
      _gridContainer_170_1.append(Operators1.add(Default.Div(List.ofArray([Default.Attr().Class("grid-row")])),Arrays.init(4,function()
      {
     ...
     _objectArg_254=_inputManager_199_1.get_Move();
     Util.addListener(_objectArg_254,function(dir)
     {
      ...
      if(_isGameTerminated_195_1.get_Value())
       ...
       {
        matchValue=Client1.moveGrid(_score_181_1,Runtime.Tupled(function(tupledArg)
        {
        ...
        if(matchValue.$==1)
         {
          ...
          return _actuate_208_1(!Model.moveAvailable(Runtime.Tupled(function(tupledArg)
          {
           return rules.Merge(tupledArg[0],tupledArg[1]);
     ...
     Util.addListener(_inputManager_199_1.get_Restart(),_arg00_267_1);
     _arg00_270_2=function()
     {
      _keepPlaying_194_1.set_Value(true);
      return continueGame(null);
     };
     Util.addListener(_inputManager_199_1.get_KeepPlaying(),_arg00_270_2);
     return _setRules_223_1(IntrinsicFunctionProxy.GetArray(Variants.All(),0));
    }),
    ...
    {
     var len1,len2,newGrid,ps,i,j,merged,j1,i1,merged1,j2,i2,merged2,i3,j3,merged3;
     len1=grid.length;
   ...
   InputManager:{
    InputManager:Runtime.Class({
     ...
     New:function()
     {
      ...
      {
       var key,matchValue,dir,_this,_this1;
       key=e.which;
      ...
      {
       var touchEndClient,changedTouch,dx,absDx,dy,absDy,objectArg,arg00;
