...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Arrays,IntrinsicFunctionProxy,Seq,Operators,window,Strings,Html,Default,List,Collections,ResizeArray,ResizeArrayProxy,T,Game2048,Array2D,JavaScript,jQuery,Variants,LocalStorage,Ref,Operators1,Client,HtmlActuator,InputManager,InputManager1,JSONStorageItem,Util,Model,Arrays2D,Option,OperatorIntrinsics,Array,Unchecked,Control,FSharpEvent,FSharpMap,document,MapModule,Math,JSON,alert,Number,OriginalRules,FibonacciRules,PlusMinusRules,GameRules;
 Runtime.Define(Global,{
  Game2048:{
   Array:{
    pad:function(length,array)
    {
     ...
     for(i=1;i<=length-IntrinsicFunctionProxy.GetLength(array);i++){
      ps=[{
       $:0
      }];
      res.push.apply(res,[].concat(ps));
     }
     return res;
    }
   },
     ...
     while(!found?i<len1:false)
      {
       ...
       while(!found?j<len2:false)
        {
         found=predicate(IntrinsicFunctionProxy.GetArray2D(array,i,j));
         j=j+1;
        }
       i=i+1;
      }
   ...
   Client:{
    HtmlActuator:Runtime.Class({
     Actuate:function(grid,state)
     {
      ...
      {
       var positionClass,applyClasses,addTile,diff,message;
       _this.tileContainer.empty();
       positionClass=Runtime.Tupled(function(tupledArg)
       {
        var y;
        y=tupledArg[1];
       ...
       applyClasses=function(el)
       {
        ...
        {
         return el["HtmlProvider@32"].SetAttribute(el.Body,"class",Strings.concat(" ",classes));
        };
       };
       addTile=function(moveTo)
       {
        return function(addClass)
        {
         ...
         {
          var inner,classes,wrapper,pos;
          inner=Default.Div(List.ofArray([Default.Attr().Class("tile-inner"),Default.Text(Global.String(tile.Value))]));
          classes=ResizeArrayProxy.New11(List.append(List.ofArray(["tile","tile-"+Global.String(tile.Value),positionClass(tile.Pos)]),addClass));
          wrapper=Default.Div(List.ofArray([inner]));
          if(tile.Value>2048)
           {
            classes.Add("tile-super");
           }
          (applyClasses(wrapper))(classes);
          _this.tileContainer.append(wrapper.Body);
          if(moveTo.$==1)
           {
            pos=moveTo.$0;
            return window.requestAnimationFrame(function()
       ...
       if(diff>0)
        {
         _this.scoreContainer.append(Default.Div(List.ofArray([Default.Attr().Class("score-addition"),Default.Text("+"+Global.String(diff))])).Body);
        }
    ...
    {
     var _selectGameType_162_1,idx,v,_rules_167_1,_gridContainer_169_1,i,_storedGame_178_1,_score_180_1,_bestScore_181_1,_grid_182_1,_keepPlaying_193_1,_isGameTerminated_194_1,_actuator_196_1,_inputManager_198_1,_actuate_207_1,continueGame,_setRules_222_1,_objectArg_253,_arg00_266_1,_arg00_269_2;
     _selectGameType_162_1=jQuery(".select-gametype");
     for(idx=0;idx<=Variants.All().length-1;idx++){
      v=IntrinsicFunctionProxy.GetArray(Variants.All(),idx);
      _selectGameType_162_1.append("<option value=\""+v.get_Name()+"\">"+v.get_Name()+"</option>");
     }
     _rules_167_1=Ref.New(undefined);
     _gridContainer_169_1=jQuery(".grid-container");
     for(i=1;i<=4;i++){
      _gridContainer_169_1.append(Operators1.add(Default.Div(List.ofArray([Default.Attr().Class("grid-row")])),Arrays.init(4,function()
      {
       return Default.Div(List.ofArray([Default.Attr().Class("grid-cell")]));
      })).Body);
     }
     _storedGame_178_1=Ref.New(undefined);
     _score_180_1=Ref.New(0);
     _bestScore_181_1=Ref.New(0);
     _grid_182_1=Ref.New(null);
     _keepPlaying_193_1=Ref.New(false);
     _isGameTerminated_194_1=Ref.New(false);
     _actuator_196_1=HtmlActuator.New();
     _inputManager_198_1=InputManager1.New();
     _actuate_207_1=function(over,won)
     {
      _storedGame_178_1.get_Value().set_Value({
       Values:over?{
        $:0
       }:{
        $:1,
        $0:Client.gridValues(_grid_182_1.get_Value())
       },
       Score:_score_180_1.get_Value(),
       BestScore:_bestScore_181_1.get_Value()
      });
      _isGameTerminated_194_1.set_Value(over?true:won?!_keepPlaying_193_1.get_Value():false);
      return _actuator_196_1.Actuate(_grid_182_1.get_Value(),{
       Score:_score_180_1.get_Value(),
       Over:over,
       Won:won,
       BestScore:_bestScore_181_1.get_Value(),
       Terminated:_isGameTerminated_194_1.get_Value()
      });
     };
     continueGame=function()
     {
      _isGameTerminated_194_1.set_Value(false);
      return _actuator_196_1.ClearMessage();
     };
     _setRules_222_1=function(r)
     {
      var stored,matchValue;
      _rules_167_1.set_Value(r);
      jQuery(".title").html(r.get_Title());
      jQuery(".game-intro").html(r.get_Hint());
      _storedGame_178_1.set_Value(JSONStorageItem.New(r.get_Name(),{
       Values:{
        $:0
       },
       Score:0,
      ...
      stored=_storedGame_178_1.get_Value().get_Value();
      _score_180_1.set_Value(stored.Score);
      _bestScore_181_1.set_Value(stored.BestScore);
      matchValue=stored.Values;
      _grid_182_1.set_Value(matchValue.$==1?Client.gridFromValues(matchValue.$0):_rules_167_1.get_Value().Start());
      _keepPlaying_193_1.set_Value(false);
      continueGame(null);
      return _actuate_207_1(false,false);
     };
     _selectGameType_162_1.on("change",function()
     {
      var v1,idx1,r;
      v1=_selectGameType_162_1.val();
      for(idx1=0;idx1<=Variants.All().length-1;idx1++){
       r=IntrinsicFunctionProxy.GetArray(Variants.All(),idx1);
       if(v1===r.get_Name())
        {
         _setRules_222_1(r);
        }
       _selectGameType_162_1.blur();
      }
      return true;
     });
     _objectArg_253=_inputManager_198_1.get_Move();
     Util.addListener(_objectArg_253,function(dir)
     {
      var rules,matchValue;
      rules=_rules_167_1.get_Value();
      if(_isGameTerminated_194_1.get_Value())
       {
        return null;
       }
      else
       {
        matchValue=Client.moveGrid(_score_180_1,Runtime.Tupled(function(tupledArg)
        {
         return rules.Merge(tupledArg[0],tupledArg[1]);
        }),_grid_182_1.get_Value(),dir);
        if(matchValue.$==1)
         {
          _grid_182_1.set_Value(matchValue.$0);
          rules.Next(_grid_182_1.get_Value());
          if(_bestScore_181_1.get_Value()<_score_180_1.get_Value())
           {
            _bestScore_181_1.set_Value(_score_180_1.get_Value());
           }
          return _actuate_207_1(!Model.moveAvailable(Runtime.Tupled(function(tupledArg)
          {
           return rules.Merge(tupledArg[0],tupledArg[1]);
          }),_grid_182_1.get_Value()),rules.Goal(_grid_182_1.get_Value()));
         }
        else
         {
          return null;
     ...
     {
      _score_180_1.set_Value(0);
      _grid_182_1.set_Value(_rules_167_1.get_Value().Start());
      _keepPlaying_193_1.set_Value(false);
      continueGame(null);
      return _actuate_207_1(false,false);
     };
     Util.addListener(_inputManager_198_1.get_Restart(),_arg00_266_1);
     _arg00_269_2=function()
     {
      _keepPlaying_193_1.set_Value(true);
      return continueGame(null);
     };
     Util.addListener(_inputManager_198_1.get_KeepPlaying(),_arg00_269_2);
     return _setRules_222_1(IntrinsicFunctionProxy.GetArray(Variants.All(),0));
    }),
    ...
    moveGrid:function(scoreRef,merge,grid,dir)
    {
     ...
     newGrid=Arrays2D.zeroCreate(len1,len2);
     ...
     if(dir.$==1)
      {
       for(i=0;i<=len1-1;i++){
        ...
        {
         return x;
        },OperatorIntrinsics.GetArraySlice2DFixed1(grid,i,{
         $:0
        },{
         $:0
        })).slice().reverse());
        OperatorIntrinsics.SetArraySlice2DFixed1(newGrid,i,{
         $:0
        },{
         $:0
       ...
       if(dir.$==2)
        {
         for(j1=0;j1<=len2-1;j1++){
          ...
          {
           return x;
          },OperatorIntrinsics.GetArraySlice2DFixed2(grid,{
           $:0
          },{
           $:0
          },j1)));
          OperatorIntrinsics.SetArraySlice2DFixed2(newGrid,{
           $:0
          },{
           $:0
         ...
         if(dir.$==3)
         ...
         else
          {
           for(i3=0;i3<=len1-1;i3++){
            ...
            {
             return x;
            },OperatorIntrinsics.GetArraySlice2DFixed1(grid,i3,{
             $:0
            },{
             $:0
            })));
            OperatorIntrinsics.SetArraySlice2DFixed1(newGrid,i3,{
             $:0
            },{
             $:0
     ...
     return Unchecked.Equals(Client.gridValues(newGrid),Client.gridValues(grid))?{
      $:0
     }:{
      $:1,
      $0:newGrid
   ...
   InputManager:{
    InputManager:Runtime.Class({
     ...
     New:function()
     {
      ...
      map=FSharpMap.New(List.ofArray([[38,{
       $:0
      }],[39,{
       $:3
      }],[40,{
      ...
      jQuery(document).on("keydown",function(e)
      {
       var key,matchValue;
       key=e.which;
       if(!(((e.altKey?true:e.ctrlKey)?true:e.metaKey)?true:e.shiftKey))
        {
      ...
      gameContainer.on(eventTouchstart,function(e)
      {
       var touch;
       if((msPointerEnabled?e.touches.length>1:false)?true:e.targetTouches>1)
       ...
       else
        {
         if(msPointerEnabled)
          {
           r.touchStartClient=[e.pageX,e.pageY];
          }
         else
          {
      ...
      gameContainer.on(r.eventTouchend,function(e)
      {
       ...
       if((msPointerEnabled?e.touches.length>0:false)?true:e.targetTouches>0)
       ...
       else
        {
         if(msPointerEnabled)
          {
           touchEndClient=[e.pageX,e.pageY];
          }
         else
          {
           changedTouch=IntrinsicFunctionProxy.GetArray(e.changedTouches,0);
   ...
   Model:{
    ...
    addRandomTile:function(grid,value)
    {
     ...
     j1=patternInput[1];
     i1=patternInput[0];
     return IntrinsicFunctionProxy.SetArray2D(grid,i1,j1,{
      $:1,
    ...
    {
     var res,prev,idx,cell,matchValue,pcell,matchValue1,mergedValue,addedScore,tupledArg,ps,tupledArg1,ps1,matchValue2,pcell1,tupledArg2,ps2;
     res=[];
     prev=Ref.New({
      $:0
     });
     for(idx=0;idx<=row.length-1;idx++){
      cell=IntrinsicFunctionProxy.GetArray(row,idx);
        ...
        if(matchValue1.$==1)
         {
          ...
          ps=[Model.mergeTiles(tupledArg[0],tupledArg[1],mergedValue,pcell,cell)];
          res.push.apply(res,[].concat(ps));
          prev.set_Value({
           $:0
          });
        ...
        else
         {
          ...
          ps1=[Model.moveTile(tupledArg1[0],tupledArg1[1],pcell)];
          res.push.apply(res,[].concat(ps1));
          prev.set_Value({
           $:1,
           $0:cell
          });
     ...
     if(matchValue2.$==1)
      {
       ...
       ps2=[Model.moveTile(tupledArg2[0],tupledArg2[1],pcell1)];
       res.push.apply(res,[].concat(ps2));
      }
     return res;
    },
     ...
     if(Array2D.exists(function(option)
     {
     ...
     else
      {
       ...
       },Seq.delay(function()
       {
        ...
        {
         return Seq.pairwise(OperatorIntrinsics.GetArraySlice2DFixed1(gridVals,i,{
          $:0
         },{
          $:0
         }));
        },Operators.range(0,len1-1)),Seq.delay(function()
        {
         return Seq.collect(function(i)
         {
          return Seq.pairwise(OperatorIntrinsics.GetArraySlice2DFixed2(gridVals,{
           $:0
          },{
           $:0
          },i));
 ...
 Runtime.OnInit(function()
 {
  ...
  Client=Runtime.Safe(Game2048.Client);
  HtmlActuator=Runtime.Safe(Client.HtmlActuator);
